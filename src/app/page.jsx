  ...
  return (
    <main className="flex h-screen w-screen items-center justify-center bg-[#2f3349]">
      <div className="flex h-[450px] w-[450px] flex-col items-center justify-center rounded-xl">
        ...
        <form onSubmit={authentication} className="flex w-80 flex-col items-center justify-center gap-y-3">
          {/* INPUT EMAIL */}
          ...
          {/* SUBMIT BUTTON */}
          <button type="submit" className="h-11 w-full rounded-md bg-[#7367f0] font-bold text-white hover:bg-[#7367f0]/70">
            LOGIN
          </button>
          {/* SUBMIT BUTTON */}
        </form>
